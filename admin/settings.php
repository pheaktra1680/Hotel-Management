                                    ...
                                    <div class="container-fluid p-0">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label fw-bold">Phone Numebr (with country code)</label>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" class="form-control shadow-none" name="email" id="email_inp" required />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control shadow-none" name="member_picture" id="member_picture_inp" accept="[.jpg, .png, .webp, .jpeg]" required />
                                    </div>
                                </div>
                                <div class="modal-footer">
